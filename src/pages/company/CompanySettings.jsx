...
export default function CompanySettings() {
  ...
  const [notifications, setNotifications] = useState({ email: true, kol_accepted: true, deliverables: true })
    ...
    <div className="page-wrapper">
      ...
      <div className="settings-section">
        ...
        {[
          ...
          { key: 'kol_accepted', label: 'KOL acceptance alerts' },
          { key: 'deliverables', label: 'Deliverable submission alerts' },
        ].map(n => (
